...
dataset = DatasetLoader(
    dataset_json_file_path = "/SciVQA/unsloth/shared_task/train_2025-03-27_18-34-44.json",
    image_dir = "/SciVQA/unsloth/shared_task/images_train/images_train"
)

validation_dataset = DatasetLoader(
    dataset_json_file_path = "/SciVQA/unsloth/shared_task/validation_2025-03-27_18-34-44.json",
    image_dir = "/SciVQA/unsloth/shared_task/images_validation/images_validation"
)
...
training_config = {
    #"output_dir": "Qwen2_5_32B-8bit_2Epochs",
    #"output_dir": "Qwen2_5_7B-8bit_Debugging",
...
with open('/scivqa/conf/defaults.yaml', 'r') as cfg_file:
