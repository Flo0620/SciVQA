...
# Example usage
input_file = "SciVQA/SpiQa/SPIQA_train.json"
#input_file = 'SciVQA/SpiQa/SPIQA_train_fixed.json'  # Replace with your input file path
output_file = 'SciVQA/SpiQa/SPIQA_train_fixed2.json'  # Replace with your desired output file path
other_dataset_path = 'SciVQA/scivqa_train_val_test_combined.json'
#filter_json(input_file, output_file)
input_file = 'SciVQA/SpiQa/SPIQA_train_fixed.json'
