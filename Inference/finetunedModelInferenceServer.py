...
config_path = "/scivqa/conf/defaults.yaml"
with open(config_path, "r") as file:
    config = yaml.safe_load(file)
vllm_port = config.get("vllm_port", 5000)

# Initialize Flask app
app = Flask(__name__)

# Load model and processor
#adapter_path = "/SciVQA/unsloth/Qwen2_5_32GB_Debugging"
#adapter_path = "/SciVQA/unsloth/Qwen2_5_32GB_ChangedR"
